...
import { Locale } from "./dictionnaries";
...
import { FileText, Globe, Mail, Github, Linkedin } from "lucide-react";
    ...
    <main className="min-h-screen bg-cream dark:bg-neutral-950 text-sage-dark dark:text-cream transition-colors duration-300 ease-in-out selection:bg-sage selection:text-cream">
      <div className="max-w-2xl mx-auto px-6 py-12 md:py-20">
        <header className="flex justify-between items-center mb-16">
          ...
          {devEnv === "development" && (
            <>
              <div className="absolute top-4 right-[45%] flex flex-col justify-center items-center">
